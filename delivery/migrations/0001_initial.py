    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assign_time', models.DateTimeField(auto_now_add=True, verbose_name='Время выдачи курьеру')),
                ('expected_reward', models.PositiveIntegerField(verbose_name='Ожидаемое вознаграждение')),
        ...
        migrations.CreateModel(
            name='TimeInterval',
            fields=[
                ('name', models.CharField(max_length=11, primary_key=True, serialize=False, validators=[delivery.validators.interval_validator], verbose_name='Интервал(HH:MM-HH:MM)')),
                ('begin', models.PositiveIntegerField(verbose_name='Начало интервала в минутах')),
                ('end', models.PositiveIntegerField(verbose_name='Конец интервала в минутах')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_orders', to='delivery.invoice')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_orders', to='delivery.order')),
            ],
        ),
        migrations.AddField(
            model_name='invoice',
            name='orders',
            field=models.ManyToManyField(db_index=True, related_name='invoices', through='delivery.InvoiceOrder', to='delivery.Order', verbose_name='Заказы'),
        ),
        migrations.AddField(
            model_name='courier',
            name='regions',
